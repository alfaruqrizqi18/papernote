...
public class SearchResultsActivityNotesAdapter extends RecyclerView.Adapter<SearchResultsActivityNotesAdapter.ViewHolder>{
    Context context;
    private List<NotesModel> notesModels;

    public SearchResultsActivityNotesAdapter(Context context, List<NotesModel> notesModels) {
